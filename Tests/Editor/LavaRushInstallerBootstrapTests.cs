...
namespace ActionFit.LavaRushInstaller.Editor.Tests
{
    public sealed class LavaRushInstallerBootstrapTests
    {
        ...
        public void ContentBundleProfile_RequiresCompleteLavaRushSetAndAuthorizedReleaseLogin()
        {
            ...
            Assert.That(profile.bundleVersion, Is.EqualTo("0.1.8"));
            ...
            Assert.That(Version(profile, "com.actionfit.lava-rush"), Is.EqualTo("0.1.7"));
            Assert.That(Version(profile, "com.actionfit.ui.foundation"), Is.EqualTo("2.0.0"));
            Assert.That(Version(profile, "com.actionfit.lava-rush.ui"), Is.EqualTo("0.1.11"));
