...
{
  "dependencies": {
    "com.actionfit.lava-rush.installer": "https://github.com/ActionFit-Editor/LavaRushInstaller.git#0.1.1"
  }
}
```
...
2. Custom Package Manager가 없으면 canonical `1.1.95` Git URL을 먼저 설치합니다.
