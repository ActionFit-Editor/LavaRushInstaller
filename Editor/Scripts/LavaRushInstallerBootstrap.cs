...
namespace ActionFit.LavaRushInstaller.Editor
{
    ...
    internal static class LavaRushInstallerBootstrap
    {
        ...
        private const string ManagerRequestSessionKey = "ActionFit.LavaRushInstaller.ManagerRequest.0.1.16";
        private const string ManagerResolveSessionKey = "ActionFit.LavaRushInstaller.ManagerResolve.0.1.16";
